...
{
    //
    public class RequestSendString : BaseProtocolVO
    {
        
        static public RequestSendString CreateInstance()
        {
            return new RequestSendString();
        }
        ...
        public delegate void MessageHandler(RequestSendString msg);
        ...
        static public void CallHandler(RequestSendString msg)
        {
            int i = 0;
